...
const uploadFeatured = multer({ storage: imageStorage('featured-club-astronomy-image')})
...
router.post('/featured', uploadFeatured.single('image'), galleryController.uploadFeatured)
